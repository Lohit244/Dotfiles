...
awful.layout.suit.spiral, awful.layout.suit.spiral.dwindle, awful.layout.suit.max -- awful.layout.suit.max.fullscreen,
...
globalkeys = gears.table.join(
    awful.key(
    {modkey}, "s", function() hotkeys_popup.show_help(nil, awful.screen.focused()) end, {
    ...
    awful.spawn("i3lock -i " .. gears.filesystem.get_configuration_dir() .. "/wall.png -F")
    end, {
    description = "show help",
    group = "awesome"
    }), 
    ...
    awful.spawn("flameshot gui -c -p /home/lohit244/Pictures/Screenshots/")
end, {
...
awful.key({modkey}, "p", function()
    ...
    description = "show ranger",
    group = "launcher"
}), awful.key({modkey, "Shift"}, "p", function()
    awful.spawn("nautilus")
end, {
    description = "spawn Nautilus",
    group = "launcher"
}))

clientkeys = gears.table.join(awful.key({modkey, "Control"}, "f", function(c)
...
-- }}}
awful.util.spawn(gears.filesystem.get_configuration_dir() .. "/autostart.sh")
